      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-10">
        ...
        >
          {projects.map((project) => (
            ...
            >
              <div className="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-teal-500/70 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-xl font-semibold text-slate-900 dark:text-white">{project.title.trim()}</h3>
                ...
                <div className="relative mt-5 flex items-center gap-3 text-sm font-semibold text-teal-600 dark:text-teal-200">
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1 rounded-full border border-slate-200 dark:border-white/10 bg-white/50 dark:bg-white/5 px-3 py-2 transition hover:-translate-y-0.5 hover:border-teal-400"
                    >
                      GitHub →
                    </a>
                  )}
                  {project.demo && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1 rounded-full border border-slate-200 dark:border-white/10 bg-white/50 dark:bg-white/5 px-3 py-2 text-slate-700 dark:text-slate-100 transition hover:-translate-y-0.5 hover:border-teal-400 hover:text-teal-600 dark:hover:text-teal-100"
                    >
                      Live Demo →
                    </a>
                  )}
